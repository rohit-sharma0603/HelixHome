...
//                   type="text"
//                   id="name"
//                   className="w-full border border-gray-300 rounded-lg px-4 py-2 text-gray-800 focus:ring-2 focus:ring-teal-500"
...
//               <button
//                 type="submit"
//                 className="w-full bg-teal-600 text-white font-medium py-2 rounded-lg shadow-lg hover:bg-teal-700 transition"
//               >
//                 Send Message
//               </button>
//             </form>
          ...
          <form className="space-y-4">
            <div>
              ...
              <input
                type="text"
                id="name"
                className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-teal-400"
            ...
            <button
              type="submit"
              className="w-full bg-teal-500 text-white font-medium py-2 rounded-md shadow-md hover:bg-teal-600 transition"
            >
              Send Message
            </button>
          </form>
