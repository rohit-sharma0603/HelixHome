...
// // import { FaBars, FaCog, FaHome, FaSignOutAlt, FaUserAlt, FaImage, FaPen, FaPhotoVideo } from 'react-icons/fa';
...
// //           </Link>
// //           <Link to="/admin/settings" className="flex items-center gap-4 text-lg hover:text-gray-300">
// //             <FaUserAlt size={20} />
...
// //         {/* Logout Button */}
// //         <button
// //           className="mt-auto flex items-center gap-4 bg-red-600 text-white py-2 px-4 rounded hover:bg-red-700 w-full"
...
// import React, { useState } from 'react';
// import { Outlet, Link, useNavigate } from 'react-router-dom';
// import { FaBars, FaCog, FaSignOutAlt, FaUserAlt, FaImage, FaPhotoVideo, FaDesktop } from 'react-icons/fa';
    ...
    <div className="flex h-[90vh] bg-gray-200">
      ...
      >
        ...
        <nav className="flex flex-col gap-6">
          ...
          <Link to="/admin/downloads" className="flex items-center gap-4 text-lg hover:text-gray-300">
            <FaDownload size={20} />
            {isSidebarOpen && <span>Downloads</span>}
          </Link>
          <Link to="/admin/director-desk" className="flex items-center gap-4 text-lg hover:text-gray-300">
            <FaUserTie size={20} />
